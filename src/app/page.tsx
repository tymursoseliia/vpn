      ...
      <section id="download" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a href="https://github.com/tymursoseliia/PhantomLink/releases/download/v1.0.0/PhantomLink-Windows.zip" className="flex flex-col items-center justify-center p-8 w-64 rounded-3xl bg-card border border-white/10 hover:border-primary/50 hover:bg-white/5 transition-all group">
            ...
            <a href="https://github.com/tymursoseliia/PhantomLink/releases/download/v1.0.0/PhantomLink-MacOS.zip" className="flex flex-col items-center justify-center p-8 w-64 rounded-3xl bg-card border border-white/10 hover:border-primary/50 hover:bg-white/5 transition-all group">
              <div className="w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform">
            ...
            <a href="https://github.com/tymursoseliia/PhantomLink/releases/download/v1.0.0/PhantomLink-Android.zip" className="flex flex-col items-center justify-center p-8 w-64 rounded-3xl bg-card border border-white/10 hover:border-primary/50 hover:bg-white/5 transition-all group">
              <div className="w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform">
